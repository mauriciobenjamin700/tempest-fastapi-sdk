...
_BUILTIN_TRANSLATIONS: dict[str, dict[str, str]] = {
    "pt-BR": {
        ...
        "ORDER_BY_NOT_ALLOWED": "Não é possível ordenar por este campo",
        "PAGE_SIZE_TOO_LARGE": "Tamanho de página acima do máximo permitido",
    ...
    "en-US": {
        ...
        "ORDER_BY_NOT_ALLOWED": "Cannot order by this field",
        "PAGE_SIZE_TOO_LARGE": "Page size is above the allowed maximum",
